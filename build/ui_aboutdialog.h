...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About GopnikCoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>GopnikCoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The GopnikCoin developers", Q_NULLPTR));

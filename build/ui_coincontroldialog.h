...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 GPK"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 GPK"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 GPK"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 GPK"));
